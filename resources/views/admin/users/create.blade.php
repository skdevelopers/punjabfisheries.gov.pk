<x-app-layout title="Create User" is-header-blur="true">
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="card col-span-12">
                <div class="flex items-center justify-between p-4 sm:p-5">
                    <div>
                        <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">Create New User</h2>
                        <p class="text-slate-500 dark:text-navy-200">Add a new user to the system</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" 
                                       class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent dark:bg-navy-600 dark:text-navy-100 @error('name') border-red-500 @else border-slate-300 dark:border-navy-400 @enderror" 
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="directorate_name" value="{{ old('directorate_name') }}" 
