<x-app-layout title="Fish Sellings" is-header-blur="true">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h1 class="text-2xl font-semibold text-slate-800 dark:text-navy-50">Fish Sellings</h1>
                                    <p class="text-slate-500 dark:text-navy-200 text-sm mt-1">Manage fish selling records</p>
                                </div>
                                <a href="{{ route('crm.fish-sellings.create') }}" class="btn bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody class="bg-white dark:bg-navy-800 divide-y divide-slate-200 dark:divide-navy-600">
                                    @forelse($fishSellings as $fishSelling)
                                        <tr class="hover:bg-slate-50 dark:hover:bg-navy-700 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        <div class="text-sm font-medium text-slate-900 dark:text-navy-50">{{ $fishSelling->species }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-slate-900 dark:text-navy-50">{{ $fishSelling->created_at->format('M d, Y') }}</div>
                                                <div class="text-xs text-slate-500 dark:text-navy-200">{{ $fishSelling->created_at->format('g:i A') }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center space-x-2">
                                                    <a href="{{ route('crm.fish-sellings.show', $fishSelling->id) }}" 
                                                    ...
                                                    <form action="{{ route('crm.fish-sellings.destroy', $fishSelling->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this record?')">
                                                        @csrf
                                                        @method('DELETE')
                                        ...
                                        <tr>
                                            <td colspan="8" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <h3 class="text-lg font-medium text-slate-900 dark:text-navy-50 mb-2">No fish selling records found</h3>
                                                    <p class="text-slate-500 dark:text-navy-200 mb-4">Get started by creating your first fish selling record.</p>
                                                    <a href="{{ route('crm.fish-sellings.create') }}" class="btn bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
                                                        <svg class="size-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                                        </svg>
