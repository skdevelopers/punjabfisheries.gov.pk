<x-app-layout title="Create New Announcement" is-header-blur="true">
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="card col-span-12">
                <div class="flex items-center justify-between p-4 sm:p-5">
                    <div>
                        <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">Create New Announcement</h2>
                        <p class="text-slate-500 dark:text-navy-200">Add a new announcement or notice</p>
                    </div>
                    <a href="{{ route('cms.announcements.index') }}" class="btn bg-secondary font-medium text-white hover:bg-secondary-focus focus:bg-secondary-focus active:bg-secondary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                ...
                <div class="p-4 sm:p-5">
                    <form action="{{ route('cms.announcements.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select class="form-select w-full @error('type') border-red-500 @enderror" 
                                        ...
                                        <option value="corrigendum" {{ old('type') == 'corrigendum' ? 'selected' : '' }}>Corrigendum</option>
                                    </select>
                                    @error('type')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
