<x-app-layout title="Create Category" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="mt-4 sm:mt-5 lg:mt-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <div>
                    <h1 class="text-2xl font-semibold text-slate-800 dark:text-navy-50">Create New Category</h1>
                    <p class="text-slate-500 dark:text-navy-200">Add a new blog category</p>
                </div>
            ...
            <div class="card p-4 sm:p-5">
                <form method="POST" action="{{ route('cms.blog-categories.store') }}">
                    @csrf
