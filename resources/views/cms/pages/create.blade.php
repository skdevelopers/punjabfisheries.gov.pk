<x-app-layout title="Create New Page" is-header-blur="true">
                ...
                <div class="p-8">
                    <div class="mb-8">
                        <div class="flex items-center mb-4">
                            ...
                            <h1 class="text-3xl font-semibold text-slate-800 dark:text-navy-50 m-0">Create New Page</h1>
                        </div>
                        <p class="text-slate-500 dark:text-navy-200 text-base">Add a new page to your website</p>
                    </div>

                    <form action="{{ route('cms.pages.store') }}" method="POST" enctype="multipart/form-data" class="max-w-7xl">
                        @csrf
                            ...
                            <div class="lg:col-span-2">
                                <div class="card p-6 mb-6">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" name="title" required class="form-input w-full rounded-lg border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Enter page title">
                                        @error('title')
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" name="slug" required class="form-input w-full rounded-lg border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent font-mono" placeholder="page-url-slug">
                                        @error('slug')
                                            <p class="text-error text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="border border-slate-300 dark:border-navy-450 rounded-lg overflow-hidden">
                                            ...
                                            <!-- Editor -->
                                            <div id="editor" contenteditable="true" class="min-h-96 p-4 outline-none text-base leading-relaxed bg-white dark:bg-navy-700 text-slate-700 dark:text-navy-200" placeholder="Start writing your content here..."></div>
                                        </div>
