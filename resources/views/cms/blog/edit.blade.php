            ...
            <div class="rounded-lg border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-800">
              ...
              <div class="space-y-3">
                @if($post->getFirstMedia('banner_image'))
                  ...
                  <div class="relative group">
                    <img src="{{ $post->getFirstMedia('banner_image')->getUrl() }}" alt="Current banner image" class="w-full h-32 object-cover rounded-lg border border-slate-200 dark:border-slate-700">
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-200 rounded-lg flex items-center justify-center">
                      <div class="opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex gap-2">
