<x-app-layout title="Create Tender" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="card">
            <div class="p-4 sm:p-5">
                <form action="{{ route('cms.tenders.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="tender_number" value="{{ old('tender_number') }}" required
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" rows="4" required
                                ...
                                placeholder="Enter tender description...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">Maximum file size: 10MB</p>
                            @error('pdf_file')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
