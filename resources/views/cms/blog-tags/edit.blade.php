<x-app-layout title="Edit Tag" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="mt-4 sm:mt-5 lg:mt-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <div>
                    <h1 class="text-2xl font-semibold text-slate-800 dark:text-navy-50">Edit Tag</h1>
                    <p class="text-slate-500 dark:text-navy-200">Update tag information</p>
                </div>
            ...
            <div class="card p-4 sm:p-5">
                <form method="POST" action="{{ route('cms.blog-tags.update', $tag) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="color" id="color" name="color" value="{{ old('color', $tag->color) }}" required 
