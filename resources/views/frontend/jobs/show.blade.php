<x-app-layout title="{{ $career->title }} - Department of Fisheries Punjab">

    <!-- Page Header -->
    <section class="pt-32 pb-20 bg-primary-50">
      <div class="cont">
        <div class="text-center">
          <h1 class="text-4xl xl:text-5xl font-bold text-neutral-900 mb-4">{{ $career->title }}</h1>
          ...
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-primary-500 to-primary-600 p-8 text-white">
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  <h2 class="text-3xl font-bold mb-4">{{ $career->title }}</h2>
                  <div class="flex flex-wrap gap-4 text-sm">
                    ...
                    <div class="flex items-center">
                      ...
                      <span>Posted: {{ $career->created_at->format('M d, Y') }}</span>
                    </div>
                  </div>
                </div>
                <div class="ml-6">
            ...
            <div class="p-8">
              <div class="prose max-w-none">
                <h3 class="text-2xl font-semibold text-gray-900 mb-4">Career Description</h3>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                  @if($career->hasAttachment())
                    <a href="{{ $career->attachment_url }}"
                      ...
                      Download Career Advertisement ({{ strtoupper($career->attachment_type) }})
                    </a>
                  @endif
