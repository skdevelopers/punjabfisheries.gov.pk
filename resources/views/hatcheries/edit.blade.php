<x-app-layout title="Edit Office" is-header-blur="true">
                ...
                <div class="p-8">
                    <div class="mb-8">
                        <div class="flex items-center mb-4">
                            ...
                            <h1 class="text-3xl font-semibold text-slate-800 dark:text-navy-50 m-0">Edit Office</h1>
                        </div>
                        <p class="text-slate-500 dark:text-navy-200 text-base">Update office information</p>
                    </div>
                    ...
                    <form action="{{ route('crm.hatcheries.update', $hatchery->id) }}" method="POST" class="max-w-7xl">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   id="contact_person" 
                                                   name="contact_person" 
                                                   value="{{ old('contact_person', $hatchery->contact_person) }}"
                                                   class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20"
                                                   required>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   id="mobile_number" 
                                                   name="mobile_number" 
                                                   value="{{ old('mobile_number', $hatchery->mobile_number) }}"
                                                   class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20"
                                                   required>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   id="office_number" 
                                                   name="office_number" 
                                                   value="{{ old('office_number', $hatchery->office_number) }}"
                                                   class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   id="division" 
                                                   name="division" 
                                                   value="{{ old('division', $hatchery->division) }}"
                                                   class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20"
                                                   required>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" 
                                                   id="district" 
                                                   name="district" 
                                                   value="{{ old('district', $hatchery->district) }}"
                                                   class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20"
                                                   required>
                                        </div>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <textarea id="office_address" 
                                                      ...
                                                      rows="3"
                                                      class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20"
                                                      placeholder="Enter office address">{{ old('office_address', $hatchery->office_address) }}</textarea>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" 
                                                   id="longitude" 
                                                   name="longitude" 
                                                   value="{{ old('longitude', $hatchery->longitude) }}"
                                                   step="0.00000001"
                                                   min="-180" 
                                                   max="180"
                                                   class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" 
                                                   id="latitude" 
                                                   name="latitude" 
                                                   value="{{ old('latitude', $hatchery->latitude) }}"
                                                   step="0.00000001"
                                                   min="-90" 
                                                   max="90"
                                                   class="form-input w-full rounded-lg border-2 border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent dark:focus:ring-accent/20"
                                            ...
                                            <div class="space-y-3 p-4 border border-slate-200 dark:border-navy-600 rounded-lg bg-slate-50 dark:bg-navy-800">
                                                <label class="inline-flex items-center space-x-3 cursor-pointer">
                                                    <input type="radio" 
                                                           name="office_type" 
                                                           value="HM" 
                                                           {{ old('office_type', $hatchery->office_type) === 'HM' ? 'checked' : '' }}
                                                ...
                                                <label class="inline-flex items-center space-x-3 cursor-pointer">
                                                    <input type="radio" 
                                                           name="office_type" 
                                                           value="AQUA" 
                                                           {{ old('office_type', $hatchery->office_type) === 'AQUA' ? 'checked' : '' }}
                                                           class="form-radio is-basic size-5 rounded-full border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent"
                                                           required>
