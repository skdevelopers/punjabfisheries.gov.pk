...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-layout','data' => ['title' => 'Influencer Dashboard','isHeaderBlur' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Influencer Dashboard','is-header-blur' => 'true']); ?>
            ...
            <div class="flex flex-col rounded-xl bg-info/10 py-5 dark:bg-navy-800 lg:flex-row">
                ...
                <div class="scrollbar-sm mt-5 flex space-x-4 overflow-x-auto px-4 sm:px-5 lg:mt-0 lg:pl-0">
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/instagram-round.svg')); ?>"
                            alt="flag" />
                    ...
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/facebook-round.svg')); ?>"
                            alt="flag" />
                    ...
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/tik_tok-round.svg')); ?>"
                            alt="flag" />
                    ...
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/twitter-round.svg')); ?>"
                            alt="flag" />
                    ...
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/pinterest-round.svg')); ?>"
                            alt="flag" />
                    ...
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/discord-round.svg')); ?>"
                            alt="flag" />
                    ...
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/youtube-round.svg')); ?>"
                            alt="flag" />
                    ...
                    <div class="flex w-36 shrink-0 flex-col items-center">
                        <img class="z-10 size-10" src="<?php echo e(asset('images/logos/tumblr-round.svg')); ?>"
                            alt="flag" />
...
<?php endif; ?>
<?php /**PATH D:\lineone\lineone-laravel\resources\views/pages/dashboards-influencer.blade.php ENDPATH**/ ?>