...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-layout','data' => ['title' => 'CRM Analytics Dashboard','isHeaderBlur' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'CRM Analytics Dashboard','is-header-blur' => 'true']); ?>
                                ...
                                <div class="flex -space-x-3">
                                    <div class="avatar size-8 hover:z-10">
                                        <img class="rounded-full ring-3 ring-white dark:ring-navy-700"
                                            src="<?php echo e(asset('images/200x200.png')); ?>" alt="avatar" />
                                    </div>
                                    <div class="avatar size-8 hover:z-10">
                                        <div
            ...
            <div
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    <div class="flex items-center justify-between space-x-2">
                        <div class="flex items-center space-x-3">
                            <div class="avatar">
                                <img class="mask is-squircle" src="<?php echo e(asset('images/200x200.png')); ?>"
                                    alt="image" />
                            </div>
                            <div>
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img x-tooltip="'Award Level 1'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-19.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 2'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-2.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-5.svg')); ?>" alt="avatar" />
                        </div>
                        <button
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img x-tooltip="'Award Level 1'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-1.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 2'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-6.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-9.svg')); ?>" alt="avatar" />
                        </div>
                        <button
                            class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img x-tooltip="'Award Level 2'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-14.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-13.svg')); ?>" alt="avatar" />
                        </div>
                        <button
                            class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img x-tooltip="'Award Level 2'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-15.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-13.svg')); ?>" alt="avatar" />
                        </div>
                        <button
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            ...
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-5.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-25.svg')); ?>" alt="avatar" />
                        </div>
                        <button
                            class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img x-tooltip="'Award Level 2'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-1.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-24.svg')); ?>" alt="avatar" />
                            <img x-tooltip="'Award Level 3'" class="size-6"
                                src="<?php echo e(asset('images/awards/award-30.svg')); ?>" alt="avatar" />
                        </div>
                        <button
                            class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
...
<?php endif; ?>
<?php /**PATH D:\lineone\lineone-laravel\resources\views/pages/dashboards-crm-analytics.blade.php ENDPATH**/ ?>