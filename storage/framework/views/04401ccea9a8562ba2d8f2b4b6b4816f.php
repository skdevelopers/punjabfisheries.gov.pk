...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base-layout','data' => ['title' => 'Login']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => 'Login']); ?>
    <div class="fixed top-0 hidden p-6 lg:block lg:px-12">
        <a href="#" class="flex items-center space-x-2">
            <img class="size-12" src="<?php echo e(asset('images/app-logo.svg')); ?>" alt="logo" />
    ...
    <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full max-w-lg p-6">
            <img class="w-full" x-show="!$store.global.isDarkModeEnabled"
                src="<?php echo e(asset('images/illustrations/dashboard-check.svg')); ?>" alt="image" />
            <img class="w-full" x-show="$store.global.isDarkModeEnabled"
                src="<?php echo e(asset('images/illustrations/dashboard-check-dark.svg')); ?>" alt="image" />
        </div>
    </div>
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            <div class="text-center">
                <img class="mx-auto size-16 lg:hidden" src="<?php echo e(asset('images/app-logo.svg')); ?>" alt="logo" />
                <div class="mt-4">
            ...
            <form class="mt-16" action="<?php echo e(route('login')); ?>" method="post">
                ...
                <div>
                    <label class="relative flex">
                        <input
                            ...
                            value="<?php echo e(old('email') ?? 'help@piniastudio.com'); ?>" />
                        <span
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="text-tiny-plus text-error"><?php echo e($message); ?></span>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4 text-center text-xs-plus">
                    <p class="line-clamp-1">
                        ...
                        <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent"
                            href="<?php echo e(route('registerView')); ?>">Create account</a>
                    </p>
                </div>
                ...
                <div class="flex space-x-4">
                    <button
                        ...
                        <img class="size-5.5" src="<?php echo e(asset('images/logos/google.svg')); ?>" alt="logo" />
                        <span>Google</span>
                    </button>
                    <button
                        class="btn w-full space-x-3 border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                        <img class="size-5.5" src="<?php echo e(asset('images/logos/github.svg')); ?>" alt="logo" />
                        <span>Github</span>
                    </button>
                </div>
            </form>
...
<?php endif; ?>
<?php /**PATH D:\lineone\lineone-laravel\resources\views/login.blade.php ENDPATH**/ ?>