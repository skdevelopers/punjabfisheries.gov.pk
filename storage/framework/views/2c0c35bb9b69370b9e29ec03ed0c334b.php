        ...
        <div x-data="{ activeTab: 'tabHome' }"
            ...
            <div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                    ...
                    <div class="swiper mt-3 px-3" x-init="$nextTick(() => new Swiper($el, { slidesPerView: 'auto', spaceBetween: 16 }))">
                        <div class="swiper-wrapper">
                            <div
                                ...
                                <div class="grow">
                                    <img class="h-3" src="<?php echo e(asset('images/payments/cc-visa-white.svg')); ?>"
                                        alt="image" />
                                </div>
                ...
                <div class="mt-4 px-3">
                    ...
                    <div class="mt-3 flex space-x-3">
                        <a href="<?php echo e(route('apps/kanban')); ?>" class="w-12 text-center">
                        ...
                        <a href="<?php echo e(route('dashboards/crm-analytics')); ?>" class="w-12 text-center">
                            <div class="avatar size-10">
                        ...
                        <a href="<?php echo e(route('apps/chat')); ?>" class="w-12 text-center">
                            <div class="avatar size-10">
                        ...
                        <a href="<?php echo e(route('apps/filemanager')); ?>" class="w-12 text-center">
                            <div class="avatar size-10">
                        ...
                        <a href="<?php echo e(route('dashboards/banking-1')); ?>" class="w-12 text-center">
                            <div class="avatar size-10">
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center space-x-2">
                                <img class="size-10" src="<?php echo e(asset('images/logos/bitcoin.svg')); ?>"
                                    alt="image" />
                                <div>
                        ...
                        <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                            <div class="flex items-center space-x-2">
                                <img class="size-10" src="<?php echo e(asset('images/logos/solana.svg')); ?>" alt="image" />
                                <div>
                                    <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                                        SOL
                                    </h2>
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-3 space-y-3 px-2">
                        <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                            ...
                            <img src="<?php echo e(asset('images/800x600.png')); ?>"
            ...
            <div x-show="activeTab === 'tabProjects'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                        <img class="size-10 rounded-lg object-cover object-center"
                            src="<?php echo e(asset('images/illustrations/lms-ui.svg')); ?>" alt="image" />
                        <div>
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                        <img class="size-10 rounded-lg object-cover object-center"
                            src="<?php echo e(asset('images/illustrations/store-ui.svg')); ?>" alt="image" />
                        <div>
                            <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                                Store Dashboard
                            </p>
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                        <img class="size-10 rounded-lg object-cover object-center"
                            src="<?php echo e(asset('images/illustrations/chat-ui.svg')); ?>" alt="image" />
                        <div>
                            <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                                Chat Mobile App
                            </p>
                ...
                <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                        <img class="size-10 rounded-lg object-cover object-center"
                            src="<?php echo e(asset('images/illustrations/nft.svg')); ?>" alt="image" />
                        <div>
                            <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                                NFT Marketplace App
                            </p>
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-item-content flex-1 pl-4">
                            ...
                            <div class="mt-4 grid grid-cols-3 gap-3">
                                <img class="rounded-lg" src="<?php echo e(asset('images/800x600.png')); ?>"
                                    alt="image" />
                                <img class="rounded-lg" src="<?php echo e(asset('images/800x600.png')); ?>"
                                    alt="image" />
                                <img class="rounded-lg" src="<?php echo e(asset('images/800x600.png')); ?>"
...
<?php /**PATH D:\lineone\lineone-laravel\resources\views/components/app-partials/right-sidebar.blade.php ENDPATH**/ ?>